...
Item {
    ...
    // Left-edge origins
    Streak { startX:-0.107; startY:-0.083; endX:0.870; endY:1.133; clr:"#FFDCA0"; pw:1.4; minDur:2000; maxDur:15000; minGap:1000; maxGap:6000;  delay:0     }
    ...
    Streak { startX:-0.107; startY: 0.247; endX:0.605; endY:1.133; clr:"#FFDCA0"; pw:1.8; minDur:2000; maxDur:15000; minGap:2000; maxGap:5000;  delay:4800  }
    Streak { startX:-0.107; startY: 0.417; endX:0.468; endY:1.133; clr:"#F4A340"; pw:0.6; minDur:2000; maxDur:15000; minGap:1000; maxGap:8000;  delay:1300  }
    Streak { startX:-0.107; startY: 0.587; endX:0.332; endY:1.133; clr:"#FF9898"; pw:0.9; minDur:2000; maxDur:15000; minGap:1500; maxGap:6500;  delay:7200  }
    ...
    // Top-edge origins
    Streak { startX: 0.073; startY:-0.133; endX:1.090; endY:1.133; clr:"#FF6557"; pw:0.8; minDur:2000; maxDur:15000; minGap:1200; maxGap:7000;  delay:900   }
    Streak { startX: 0.313; startY:-0.133; endX:1.107; endY:0.855; clr:"#FFDCA0"; pw:1.2; minDur:2000; maxDur:15000; minGap:600;  maxGap:6000;  delay:5500  }
